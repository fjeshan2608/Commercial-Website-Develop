                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <select class="form-select" name="cat" id="category_id" aria-label="Default select example">
                            <option selected="" value="{{$product->category_id}}">Open this select menu</option>
                            @foreach ($cat as $cat)
                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <select class="form-select" name="subcategory_id"  id="subcategory_id" aria-label="Default select example">
                            <option selected="" >{{$product->subcategory_id}}</option>
                            @foreach ($sub as $sub)
...
<input type="hidden" name="c_id" value="{{$product->product_id}}">
